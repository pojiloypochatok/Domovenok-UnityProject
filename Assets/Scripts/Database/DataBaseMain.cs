...
{
    public readonly string dataPath = Path.Combine(Application.streamingAssetsPath, "DataBaseStorage", "base.db");
...
public static class DatabaseManager
{
    ...
    public static SQLiteConnection GetConnection()
    {
        if (_connection == null)
        {
            string dataPath = Path.Combine(Application.streamingAssetsPath, "DataBaseStorage", "base.db");
